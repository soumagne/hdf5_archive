...
if (HDF5_ENABLE_Z_LIB_SUPPORT)
  ...
  if (TARGET zlib)
    # Must get full target path
    get_target_property(ZLIB_CONFIG zlib IMPORTED_CONFIGURATIONS)
    get_target_property(ZLIB_LIBRARIES zlib IMPORTED_LOCATION_${ZLIB_CONFIG})
    # Get rid of version number if any
    string(REGEX REPLACE "([.[0-9]+]*)$" "" ZLIB_LIBRARIES ${ZLIB_LIBRARIES})
  endif(TARGET zlib)
  set (LINK_LIBS ${LINK_LIBS} ${ZLIB_LIBRARIES})
...
if (HDF5_ENABLE_SZIP_SUPPORT)
  ...
  if (TARGET szip)
    # Must get full target path
    get_target_property(SZIP_CONFIG szip IMPORTED_CONFIGURATIONS)
    get_target_property(SZIP_LIBRARIES szip IMPORTED_LOCATION_${SZIP_CONFIG})
    # Get rid of version number if any
    string(REGEX REPLACE "([.[0-9]+]*)$" "" SZIP_LIBRARIES ${SZIP_LIBRARIES})
  endif(TARGET szip)
  set (LINK_LIBS ${LINK_LIBS} ${SZIP_LIBRARIES})
