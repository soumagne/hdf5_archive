...
static void *H5X_dummy_create(hid_t dataset_id, hid_t xcpl_id, hid_t xapl_id,
    size_t *metadata_size, void **metadata);
static herr_t H5X_dummy_remove(hid_t file_id, size_t metadata_size,
    void *metadata);
static void *H5X_dummy_open(hid_t dataset_id, hid_t xapl_id, size_t
    metadata_size, void *metadata);
static herr_t H5X_dummy_close(void *idx_handle);
static herr_t H5X_dummy_pre_update(void *idx_handle, hid_t dataspace_id,
    hid_t xxpl_id);
static herr_t H5X_dummy_post_update(void *idx_handle, const void *buf,
    hid_t dataspace_id, hid_t xxpl_id);
static hid_t H5X_dummy_query(void *idx_handle, hid_t dataspace_id,
    hid_t query_id, hid_t xxpl_id);
static herr_t H5X__dummy_get_query_data_cb(void *elem, hid_t type_id,
...
/* Dummy index class */
const H5X_class_t H5X_DUMMY_FF[1] = {{
    H5X_CLASS_T_VERS,       /* (From the H5Xpublic.h header file) */
    H5X_PLUGIN_DUMMY_FF,    /* (Or whatever number is assigned) */
 ...
 */
static void *
H5X_dummy_create(hid_t dataset_id, hid_t H5_ATTR_UNUSED xcpl_id, hid_t xapl_id,
    size_t *metadata_size, void **metadata)
{
    H5X_dummy_t *dummy = NULL;
    hid_t file_id, type_id, space_id, trans_id = FAIL, rcxt_id = FAIL;
    void *buf = NULL;
    size_t buf_size;
    uint64_t version;
 ...
 */
static herr_t
H5X_dummy_remove(hid_t H5_ATTR_UNUSED file_id, size_t H5_ATTR_UNUSED metadata_size,
 ...
 */
static herr_t
H5X_dummy_pre_update(void *idx_handle, hid_t H5_ATTR_UNUSED dataspace_id,
 ...
 */
static hid_t
H5X_dummy_query(void *idx_handle, hid_t H5_ATTR_UNUSED dataspace_id,
    hid_t query_id, hid_t xxpl_id)
{
    H5X_dummy_t *dummy = (H5X_dummy_t *) idx_handle;
